...
class UserController extends Controller
{
    public function index()
    {
        ...
        return view('user.index', ['activeMenu' => $activeMenu, 'page' => $page, 'level' => $level, 'breadcrumb' => $breadcrumb]);
    }
    ...
    public function create()
    {
        ...
        $level = LevelModel::all();
        return view('user.create', ['activeMenu' => $activeMenu, 'page' => $page, 'level' => $level, 'breadcrumb' => $breadcrumb]);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('user.edit', ['breadcrumb' => $breadcrumb, 'level' => $level, 'user' => $user, 'page' => $page, 'activeMenu' => $activeMenu]);
    }
